    ...
    return(
        <View style={styles.container}>
            ...
            <TextInput placeholder='Username' style={styles.input} 
                value={newUsername} onChangeText={text => setNewUsername(text)} autoCapitalize='none'/>
            <TextInput placeholder='Password' style={styles.input} secureTextEntry={true}
                value={newPassword} onChangeText={text => setNewPassword(text)} autoCapitalize='none'/>
            <Pressable style={styles.button} onPress={()=>{createAccount(firstName, lastName, newUsername, newPassword, newAccountValidator)}}>
